...
using WesthoughtonWorldOfWicker.Models.AccountViewModels;
...
namespace WesthoughtonWorldOfWicker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        public IActionResult AddAccount(string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddAccount(AddAccountViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
